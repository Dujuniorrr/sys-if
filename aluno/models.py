...
# Durval - importando classe pessoa do modulo professor
from professor.models import Pessoa
...
class Aluno(Pessoa):
    # Durval - passando a chave estangeira da classe(tabela) curso
    ...
    def cadastrar(request):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                pdr_mt = Aluno.objects.get(matricula=".")
                matricula = "SYS22M02N0"+str(pdr_mt.pk)
                cadastra_aluno.matricula = matricula
